...
const heroImages = [
  "https://images.unsplash.com/photo-1632733711679-529326f6db12?auto=format&fit=crop&w=1200&q=85",
...
const galeri = [
  {
    ...
    img: "https://images.unsplash.com/photo-1632733711679-529326f6db12?auto=format&fit=crop&w=900&q=85",
  },
  {
    title: "Motor Bakım Kontrolü",
    img: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?auto=format&fit=crop&w=900&q=85",
  },
  {
    title: "Servis & Onarım Süreci",
    img: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&w=900&q=85",
  },
  {
    title: "Yağ ve Bakım Hizmeti",
    img: "https://images.unsplash.com/photo-1565043666747-69f6646db940?auto=format&fit=crop&w=900&q=85",
  },
  {
  ...
  {
    title: "Mobil Servis Desteği",
    img: "https://images.unsplash.com/photo-1603386329225-868f9b1ee6c9?auto=format&fit=crop&w=900&q=85",
  },
];
...
const yorumlar = [
  {
    ...
    text: "Arıza durumunda müşterinin direkt arayıp yazabileceği net bir sistem.",
  },
  {
    name: "Güven veren servis algısı",
    text: "Bol görsel, net hizmet listesi ve 7/24 açık vurgusu ile profesyonel görünüm.",
  },
  {
    name: "WhatsApp odaklı dönüşüm",
    text: "Müşteri tek tuşla arayabilir veya hazır mesajla WhatsApp üzerinden destek isteyebilir.",
  },
];
...
>
  WhatsApp
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/70 md:text-xl">
              ...
              kontrolü ve yerinde onarım hizmetleri sunar. 7/24 açık yapısıyla
              acil durumlarda hızlı iletişim kurabilir, aracınız için destek
              alabilirsiniz.
            </p>
      ...
      <section id="hizmetler" className="relative z-10 px-4 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-md text-base leading-7 text-white/60">
              Site yapısı Google’da “Antalya mobil oto servis”, “Antalya arıza
              tespit”, “yerinde oto servis” gibi aramalara uygun içeriklerle
              güçlendirildi.
            </p>
          </div>
  ...
  >
    ...
    <ArrowRight className="h-5 w-5" />
      ...
      <section id="galeri" className="relative z-10 px-4 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-black tracking-tight md:text-5xl">
              Oto servis, arıza tespit ve bakım hissini güçlendiren görsel yapı.
            </h2>
          </div>
      ...
      <section id="iletisim" className="relative z-10 px-4 py-20 md:px-8 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.3em] text-red-300">
              İletişim
            ...
            <p className="mt-6 text-base leading-8 text-white/65">
              ...
              kontrolü ve yerinde onarım hizmetleri için 07AutoRepair Premium
              Servis’e ulaşabilirsiniz.
            </p>
